...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Em dev (sem provedor de e-mail), o backend devolve o token para teste.
      ...
      {sent ? (
        <div className="space-y-4">
          <p className="text-sm text-foreground text-center">
            Se houver uma conta com esse e-mail, você receberá um link para redefinir a senha em instantes.
          </p>
          {devToken && (
            <div className="p-3 rounded-lg bg-muted text-xs break-all">
              <p className="font-medium mb-1">Modo desenvolvimento — link de teste:</p>
